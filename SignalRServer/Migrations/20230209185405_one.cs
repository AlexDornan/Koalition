...
namespace KoalitionServer.Migrations
{
    public partial class one : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GroupChatUserMTM",
                columns: table => new
                {
                    GroupChatUserMTMId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupChatUserMTM", x => x.GroupChatUserMTMId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PrivateChatUserMTM",
                columns: table => new
                {
                    PrivateChatUserMTMId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PrivateChatId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateChatUserMTM", x => x.PrivateChatUserMTMId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivateChatUser", x => new { x.PrivateChatsPrivateChatId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_PrivateChatUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
